    ...
    pointInLayer: function(p, layer, first) {
        ...
        layer.eachLayer(function(l) {
            ...
            if ((l instanceof L.MultiPolygon ||
                ...
                results.push(l);
                // //console.log(l.feature.properties.name);
                // //console.log('MultiPolygon ' + (l instanceof L.MultiPolygon));
                // //console.log('Polygon ' + (l instanceof L.Polygon));

            }else{


            }
            if(  l.feature.properties.name == 'Al Iskandariyah'){
              //console.log('-' + l.feature.properties.name);
              // //console.log('-MultiPolygon ' + (l.geometry instanceof L.MultiPolygon));
              // //console.log('-Polygon ' + (l instanceof L.Polygon));
              //console.log('-PIP ' + (gju.pointInPolygon({
              //   type: 'Point',
              //   coordinates: p
              // }, l.toGeoJSON().geometry)));
          }
...
(function () {
  ...
  function boundingBoxAroundPolyCoords (coords) {
    //console.log('boundingBoxAroundPolyCoords');
    //console.log(coords);
    var xAll = [], yAll = []
    for(var j= 0; j< coords.length; j++){
      for (var i = 0; i < coords[j].length; i++) {
        xAll.push(coords[j][i][1])
        yAll.push(coords[j][i][0])
      }
    }

    //console.log('x size: ' + xAll.length);
    //console.log('y size: ' + yAll.length);
  ...
  gju.pointInPolygon = function (p, poly) {
    ...
    //console.error('insideBox ' + (insideBox));
